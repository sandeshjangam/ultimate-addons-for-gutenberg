				...
				if ( 0 !== emptyItems.length ) {
					return (
						<div className="rating-schema-notices">
							...
							<h6> { __( "It seems that the following fields are empty. This may generate Schema errors / warnings for your Page, we recommend you to fill these fields.","ultimate-addons-for-gutenberg" ) } </h6>
							<ul className="rating-schema-notices-list">
								{ listItems }
							</ul>
							<p>{ __( "P.S. Note that this notice is visible only in the editor. This will not be visible in frontend. Also, once the required fields are added, this notice will go away.","ultimate-addons-for-gutenberg" ) }&nbsp;<a href="https://developers.google.com/search/docs/data-types/review-snippet" target="_blank" rel="noreferrer">{ __( "Read more.","ultimate-addons-for-gutenberg" ) }</a></p>
						</div>
					)
				}
			}
