			...
			if ( 0 !== emptyItems.length ) {
				return (
					<div className="how-to-schema-notices">
						...
						<p>{ __( "P.S. Note that this notice is visible only in the editor. This will not be visible in frontend. Also, once the required fields are added, this notice will go away." ) }&nbsp;<a href="https://developers.google.com/search/docs/data-types/how-to" target="_blank" rel="noreferrer">{ __( "Read more." ) }</a></p>
					</div>
				)
			}
			return ""
