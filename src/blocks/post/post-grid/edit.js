...
const postGridComponent = props => {
	...
	useEffect(() => { // Replacement for componentDidMount.
		...
		$style.setAttribute( "id", "uagb-post-grid-style-" + props.clientId.substr( 0, 8 ) )
		document.head.appendChild( $style )
	}, [])

	useEffect(() => { // Replacement for componentDidUpdate.
		
		var element = document.getElementById( "uagb-post-grid-style-" + props.clientId.substr( 0, 8 ) )
